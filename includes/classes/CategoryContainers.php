...
class CategoryContainers{
    ...
    private function getCategoryHtml($sqlData, $title, $tvShows,$movies){
        ...
        if($tvShows && $movies){
            $entities = EntityProvider::getEntites($this->con, $categoryId, 20);
        }
        else if($tvShows){
            $entities = EntityProvider::getTvShows($this->con, $categoryId, 20);
        }
        else{
            $entities = EntityProvider::getMovies($this->con, $categoryId, 20);
        }
